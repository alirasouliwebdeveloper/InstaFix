...
import {CalenderIcon, CheckIcon, ClockIcon, LocationIcon} from "@/components/icons";
...
export default function ProfessionalJobsPage() {
	return (
		<div className="">
			<h1 className="text-2xl font-bold text-gray-900 mb-6">Job Pipeline</h1>
			<Grid cols={4} gap="sm">
				<Flex direction="col" justify="start" align="start" className="w-full">
					<Flex gap="sm" justify="between" direction="row" align="center" className="mb-4 w-full">
						...
						<div
							className="min-w-[23px] h-[20px] flex items-center justify-center text-colors-muted bg-white text-[12px] font-semibold rounded-full px-1">
							3
						</div>
					</Flex>
						...
						<div key={index} className="mb-4 w-full">
							<DashboardCard>
								<Flex gap="md" direction="col" justify="center" align="start">
									<Flex direction="row" justify="between" align="start" gap="sm" className="w-full">
										<div className="text-base font-semibold">{job.title}</div>
										<div className="text-base font-semibold">
											${job.price}
										</div>
									</Flex>
									<Flex direction="row" justify="start" align="center" gap="sm" className="w-full">
										<Image src={job.userImage} alt={job.name} width={24} height={24} className="rounded-full"/>
									...
									<Flex direction="row" justify="between" align="center" gap="sm" className="w-full">
											<Button size="sm" variant="outline" className="w-full">Decline</Button>
											<Button size="sm" variant="none" className="bg-[#2B7CEE] text-white w-full">Accept</Button>
									</Flex>
								</Flex>
							</DashboardCard>
						</div>
							...
							<DashboardCard>
								<Flex gap="md" direction="col" justify="center" align="start">
									...
									<Flex direction="row" justify="between" align="center" gap="sm" className="w-full">
										...
										<Button size="sm" variant="none" className="bg-[#2B7CEE] text-white w-full">Start Job</Button>
									</Flex>
								</Flex>
							</DashboardCard>
						</div>
							...
							<DashboardCard>
								<Flex gap="md" direction="col" justify="center" align="start">
									...
									<Flex direction="row" justify="between" align="center" gap="sm" className="w-full">
										...
										<Button size="sm" variant="none" className="bg-[#8B5CF6] text-white w-full">Complete</Button>
									</Flex>
								</Flex>
							</DashboardCard>
						</div>
						...
						<div key={index} className="mb-4 w-full">
							<DashboardCard>
								<Flex gap="md" direction="col" justify="center" align="start">
									...
									<Flex direction="row" justify="center" align="center" gap="sm" className="w-full">
