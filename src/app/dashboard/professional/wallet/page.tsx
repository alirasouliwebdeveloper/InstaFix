	...
	return (
		<div>
			...
			<Flex justify="between" align="center" className="mb-6">
				<div>
					<h1 className="text-2xl font-bold text-colors-primary">Wallet & Earnings</h1>
					<p className="text-sm text-gray-500">Manage your income, withdrawals, and transaction history.</p>
				</div>
				<Flex gap="sm">
			...
			<div className="grid grid-cols-3 gap-4 mb-6">
				...
				<div className="bg-gradient-to-br from-[#3E50F7] to-[#2B3AD4] rounded-xl p-6 text-white relative overflow-hidden">
					...
					<button className="w-[60%] py-2.5 bg-white/20 hover:bg-white/30 text-white text-sm font-medium rounded-lg transition">
						Withdraw Funds
					</button>
				</div>
				...
				<DashboardCard>
					...
					<p className="text-3xl font-bold text-colors-primary mb-1">$12,840.50</p>
			...
			<div className="flex gap-6">
				...
				<div className="flex-1">
					<DashboardCard>
						<Flex justify="between" align="center" className="mb-6">
							<h2 className="text-[20px] font-semibold text-colors-primary">Recent Transactions</h2>
								...
								return (
									...
									>
										...
										<Flex align="center" gap="md">
											...
											<span className={`text-xs px-2 py-0.5 rounded-full font-medium ${statusStyles[tx.status]}`}>
												{tx.status}
											</span>
										</Flex>
									</Flex>
				...
				<div className="w-[320px] shrink-0">
					<DashboardCard>
						<Flex justify="between" align="center" className="mb-5">
							<h2 className="text-lg font-semibold text-colors-primary">Withdraw To</h2>
							<button className="w-8 h-8 flex items-center justify-center border border-gray-200 rounded-lg hover:bg-gray-50 transition">
						...
						<div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-5 text-white mb-5">
							...
							<p className="text-lg tracking-[0.2em] mb-4">•••• •••• •••• 4288</p>
								...
								>
									<div
										className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
											selectedMethod === method.id ? "border-[#3E50F7]" : "border-gray-300"
										}`}
									>
										{selectedMethod === method.id && (
									...
									<div className="flex-1 text-left">
										<p className="text-sm font-medium text-colors-primary">{method.label}</p>
