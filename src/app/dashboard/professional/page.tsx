...
const quickAccessItems = [
	{label: "Messages", href: "/dashboard/professional/messages", icon: EmailIcon, iconBg: "bg-blue-500"},
	{label: "Calendar", href: "/dashboard/professional/bookings", icon: BookingsIcon, iconBg: "bg-green-500"},
	{label: "Edit Profile", href: "/dashboard/professional/profile", icon: UsersIcon, iconBg: "bg-amber-500"},
];

const stats = [
	{label: "Today's Jobs", value: "2", subtitle: "jobs scheduled", iconBg: "bg-blue-500", icon: CalenderIcon},
	{
	...
	{label: "New Requests", value: "3", subtitle: "new requests", iconBg: "bg-purple-500", icon: PlusIcon},
	{
			...
			<DashboardCard>
				...
				<Grid cols={3} gap="sm">
					{upcomingJobs.map((job) => (
						...
						>
							<h3 className="text-base font-bold text-gray-900 mb-6">{job.title}</h3>
							<p className="text-sm text-gray-500 mb-4">booking reference : {job.reference}</p>
							<Flex align="center" gap="sm" className="text-sm text-gray-500 mb-6">
