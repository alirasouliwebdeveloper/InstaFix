          ...
          <DashboardCard>
            ...
            <div className="space-y-0">
              {services.map((service) => (
                ...
                >
                  <div>
                    <h3 className="text-sm font-semibold text-colors-primary">
                      {service.name}
                    </h3>
              ...
              {verificationDocs.map((doc) => (
                ...
                >
                  <div className="w-12 h-12 rounded-lg bg-gray-50 flex items-center justify-center mb-3">
                    {doc.icon === "shield" && (
                      <CheckCircleIcon size="lg" className="text-teal-500" />
                    )}
                    {doc.icon === "document" && (
                      <DocumentIcon size="lg" className="text-gray-400" />
                    )}
                    {doc.icon === "upload" && (
                      <UploadIcon size="lg" className="text-red-400" />
                    )}
                  </div>
